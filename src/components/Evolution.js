...
const Evolution = ({pokemon,pokeSpecies}) => {
    ...
    return (
        <div className="d-flex flex-row justify-content-center text-center">
            ...
            />
            <h4 className={`text-capitalize text-sizer mt-1 fs-2 ${pokemon.types[0].type.name}`}>{evolution.species?.name}</h4>
            </div>
            ...
            />
            <h4 className={`text-capitalize text-sizer ps-5 ms-5 fs-2 mt-1 ${pokemon.types[0].type.name}`}>{evolution.evolves_to[0].species.name} </h4>
            </div> 
            ...
            style={{borderRadius: '50%'}}
            />
            <h4 className={`text-capitalize text-sizer ps-5 ms-5 fs-2 mt-1 ${pokemon.types[0].type.name}`}>{evolution.evolves_to[0].evolves_to[0].species.name} </h4>
            </div>
            </>
            : null}
            </>
